...
# Ajouter le chemin vers Alma_toolset pour importer _string_utils
_alagareth_toolset_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "Alma_toolset")
